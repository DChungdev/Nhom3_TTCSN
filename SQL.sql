...
insert into TAIKHOAN values ('chung','123!@#'),
							('cuong','123!@#'),
							('dao','123!@#'),
							('cong','123!@#'),
							('hiep','123!@#'),
							('nghien','123!@#')
insert into SINHVIEN values ('2021000001',N'Nguyễn Đức Chung','2003-01-01','Nam',N'Hà Nội','0987654321','chung@gmail.com','chung'),
							('2021000002',N'Võ Mạnh Cường','2003-01-02','Nữ',N'TP. Hồ Chí Minh','0987654322','cuong@gmail.com','cuong'),
							('2021000003',N'Giang Quang Đạo','2003-02-03','Nam',N'Hà Nội','0987654345','dao@gmail.com','dao'),
							('2021000004',N'Quách Thành Công','2003-03-04','Nữ',N'Bắc Ninh','0987654567','cong@gmail.com','cong')
insert into MONHOC values ('20231IT601',N'Thực tập cơ sở ngành',3),
							('20231IT602',N'Thiết kế Web',3),
							('20231IT603',N'Trí tuệ nhân tạo',3)
insert into KHOA values ('CNTT',N'Khoa công nghệ thông tin'),
						('KT',N'Kế toán')
insert into GIAOVIEN values ('GV1',N'Phạm Văn Hiệp','1999-04-05',N'Hà Nội','0123456789','Thạc sĩ','hiep','CNTT'),
							('GV2',N'Nguyễn Bá Nghiễn','1999-04-06',N'Hà Nội','0912345678','Thạc sĩ','nghien','CNTT')
...
insert into LOP values ('004',N'Lớp TTCSN 4','GV1','CNTT','20231IT601'),
						('005',N'Lớp TKW 5','GV2','CNTT','20231IT602'),
						('006',N'Lớp TNTT 6','GV2','CNTT','20231IT603')
